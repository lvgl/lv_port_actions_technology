...
#else
		scroll_ctx.cube.dynamic_angle = 0;
 ...
 **********************/
#ifdef CONFIG_VG_LITE
static void _vglite_init_effect_param(uint8_t type, const ui_transform_param_t *param)
{
...
static void _vglite_scroll_effect_handle(const ui_transform_param_t *param, int *trans_end)
{
	...
	_vglite_init_effect_param(scroll_ctx.type, param);
