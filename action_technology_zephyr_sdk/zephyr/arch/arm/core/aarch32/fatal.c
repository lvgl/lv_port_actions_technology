 ...
 */
void z_do_kernel_oops(const z_arch_esf_t *esf, uint32_t msp,
	uint32_t exc_return, _callee_saved_t *callee_regs)
{
	...
	esf_copy.basic.r0 = except_saved_r0;
