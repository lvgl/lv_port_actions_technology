...
#ifdef LV_STRACE_ID_TIMER_CB
            LV_STRACE_U32X3(LV_STRACE_ID_TIMER_CB, (uintptr_t)timer, (uintptr_t)timer->timer_cb, timer->period);
#endif
            timer->timer_cb(timer);
#ifdef LV_STRACE_ID_TIMER_CB
            LV_STRACE_CALL_U32(LV_STRACE_ID_TIMER_CB, (uintptr_t)timer);
#endif
        }
