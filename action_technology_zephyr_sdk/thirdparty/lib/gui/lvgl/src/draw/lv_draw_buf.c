...
{
    lv_draw_buf_handlers_init(handlers, buf_malloc, buf_free, buf_align, NULL, NULL, width_to_stride, NULL, NULL);
}
                               ...
                               lv_draw_buf_copy_cb copy_cb)
{
    ...
    handlers->clear_cb = clear_cb;
    handlers->copy_cb = copy_cb;
}
