                         ...
                         const lv_area_t * coords)
{
    ...
    vg_lite_color_t color = lv_vg_lite_color(dsc->color, dsc->opa, false);
    ...
    LV_VG_LITE_CHECK_ERROR(vg_lite_draw(
                               ...
                               fill,
                               &matrix,
                               VG_LITE_BLEND_PREMULTIPLY_SRC_OVER,
                               color));
    ...
    if(dsc->img_src) {
        ...
        if(lv_vg_lite_buffer_open_image(&src_buf, &decoder_dsc, dsc->img_src, false, false)) {
