...
typedef void (*lv_draw_buf_clear_cb)(lv_draw_buf_t * draw_buf, const lv_area_t * area);
 ...
 * @param clear_cb             the callback to clear buffer
 * @param copy_cb              the callback to copy buffer
 */
