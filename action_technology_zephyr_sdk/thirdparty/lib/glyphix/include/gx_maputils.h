...
void LatLongToPixelXY(double latitude, double longitude, int levelOfDetail, int *pixelX,
                      int *pixelY);
...
void PixelXYToLatLong(int pixelX, int pixelY, int levelOfDetail, double *latitude,
                      double *longitude);
...
Point getFootPoint(Point point, Point start, Point end);

float getDistance(Point point1, Point point2);

float getEarthDistance(PointF point1, PointF point2);
} // namespace MapUtil
} // namespace gx
