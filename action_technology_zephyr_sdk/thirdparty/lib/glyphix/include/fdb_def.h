...
#if defined(FDB_USING_FILE_LIBC_MODE) || defined(FDB_USING_FILE_POSIX_MODE) || defined(FDB_USING_FILE_GLYPHIX_MODE)
...
#else
    void *cur_file[FDB_FILE_CACHE_TABLE_SIZE];   /**< current file object */
