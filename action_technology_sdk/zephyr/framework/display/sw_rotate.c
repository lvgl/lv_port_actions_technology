	...
	for (int j = h; j > 0; j--) {
		...
		for (int i = x2 - x1; i >= 0; i--) {
			...
			*tmp_dst = blend_l8_over_l8(*tmp_dst,
					hal_rgb16_to_l8((result[1] << 8) | result[0]), result[2]);
	...
	for (int j = h; j > 0; j--) {
		...
		for (int i = x2 - x1; i >= 0; i--) {
			...
			uint32_t color = bilinear_argb8888_fast_m8(*(uint32_t*)src1,
					*(uint32_t*)src2, *(uint32_t*)src3, *(uint32_t*)src4,
					x_frac >> 8, y_frac >> 8, 8);
			uint8_t opa = (color >> 24);
			uint8_t src_l8 = hal_rgb32_to_l8(color);
...
static void sw_transform_index124_over_l8(
	void *dst, const void *src, const uint32_t *src_clut,
	uint16_t dst_pitch, uint16_t src_pitch, uint16_t src_w, uint16_t src_h,
	uint8_t src_bpp, int16_t x, int16_t y, uint16_t w, uint16_t h,
	const sw_matrix_t *matrix)
...
void sw_transform_index4_over_l8(
		void *dst, const void *src, const uint32_t *src_clut,
		uint16_t dst_pitch, uint16_t src_pitch, uint16_t src_w, uint16_t src_h,
		int16_t x, int16_t y, uint16_t w, uint16_t h,
		const sw_matrix_t *matrix)
{
	sw_transform_index124_over_l8(dst, src, src_clut, dst_pitch, src_pitch,
			src_w, src_h, 4, x, y, w, h, matrix);
}
...
void sw_transform_index2_over_l8(
		void *dst, const void *src, const uint32_t *src_clut,
		uint16_t dst_pitch, uint16_t src_pitch, uint16_t src_w, uint16_t src_h,
		int16_t x, int16_t y, uint16_t w, uint16_t h,
		const sw_matrix_t *matrix)
...
void sw_transform_index1_over_l8(
		void *dst, const void *src, const uint32_t *src_clut,
		uint16_t dst_pitch, uint16_t src_pitch, uint16_t src_w, uint16_t src_h,
		int16_t x, int16_t y, uint16_t w, uint16_t h,
		const sw_matrix_t *matrix)
