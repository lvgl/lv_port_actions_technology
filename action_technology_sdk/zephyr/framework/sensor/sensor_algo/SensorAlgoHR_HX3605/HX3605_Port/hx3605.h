...
typedef enum { PPG_INIT, PPG_OFF, PPG_LED_OFF, CAL_INIT, CAL_OFF, RECAL_INIT } hx3605_mode_t;
...
typedef enum { MSG_LIVING_NO_WEAR, MSG_LIVING_WEAR } hx3605_living_wear_msg_code_t;

typedef enum { MSG_NO_WEAR, MSG_WEAR } hx3605_wear_msg_code_t;
...
bool hx3605_living_send_data(int32_t *new_raw_data, uint8_t dat_len, uint32_t green_data_als,
			     int16_t *gsen_data_x, int16_t *gsen_data_y, int16_t *gsen_data_z);
