...
extern char _sram_func_start[];
extern char _sram_func_end[];

/* Used by tracedump for saving backtrace */
extern char __tracedump_ram_start[];
extern char __tracedump_ram_end[];
...
#define __lvgl_bss	__attribute__((section(".lvgl.bss")))

#define __vglite_func	__attribute__((noinline))			\
			__attribute__((long_call, section(".vglite.func")))

#define __vglite_bss	__attribute__((section(".vglite.bss")))
