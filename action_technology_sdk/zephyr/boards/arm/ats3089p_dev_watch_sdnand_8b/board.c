...
static const struct acts_pin_config board_pin_config[] = {
    ...
    /* I2C CLK*/
    PIN_MFP_SET(GPIO_79, I2C_MFP_CFG(MFP3_I2C)),
    /* I2C DATA*/
    PIN_MFP_SET(GPIO_80, I2C_MFP_CFG(MFP3_I2C)),
#endif
...
static const struct acts_pin_config board_mmc0_config[] = {
    ...
    /* MMC0 DATA4 */
    PIN_MFP_SET(GPIO_4, SDC0_MFP_CFG_VAL),
    /* MMC0 DATA5 */
    PIN_MFP_SET(GPIO_5, SDC0_MFP_CFG_VAL),
    /* MMC0 DATA6 */
    PIN_MFP_SET(GPIO_64, SDC0_MFP_CFG_VAL),
    /* MMC0 DATA7 */
    PIN_MFP_SET(GPIO_74, SDC0_MFP_CFG_VAL),
};
#endif
