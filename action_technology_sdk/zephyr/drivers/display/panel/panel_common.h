...
/* TE scanline
 * (1) for QSPI Sync, this is the simulated te interrupt delay in milliseconds
       after the vsync signal
 * (2) for other interface, this is the scanline position where the panel
 *     triggers the TE signal through TE gpio
 */
#ifndef CONFIG_PANEL_TE_SCANLINE
#  define CONFIG_PANEL_TE_SCANLINE (0)
#endif
...
#elif CONFIG_PANEL_COLOR_DEPTH == 16
#  define CONFIG_PANEL_PIXEL_FORMAT PIXEL_FORMAT_BGR_565
#else /* CONFIG_PANEL_COLOR_DEPTH == 8 */
#  define CONFIG_PANEL_PIXEL_FORMAT PIXEL_FORMAT_L8
#endif
