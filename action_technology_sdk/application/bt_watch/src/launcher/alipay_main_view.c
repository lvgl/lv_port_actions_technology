...
static int _alipay_main_view_layout_update(view_data_t *view_data, bool first_layout)
{
	...
	if(first_layout) {
		...
		coder_simulation_tp_register(scr, ALIPAY_MAIN_VIEW, LV_DIR_HOR, 50, NULL);
	}
...
int _alipay_main_view_handler(uint16_t view_id, view_data_t *view_data, uint8_t msg_id, void *msg_data)
{
...
VIEW_DEFINE2(alipay_main_view, _alipay_main_view_handler, NULL,
