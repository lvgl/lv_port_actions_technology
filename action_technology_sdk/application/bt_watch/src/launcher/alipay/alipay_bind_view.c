...
int _alipay_bind_view_handler(uint16_t view_id, view_data_t *view_data, uint8_t msg_id, void *msg_data)
{
...
VIEW_DEFINE2(alipay_bind_view, _alipay_bind_view_handler, NULL,
