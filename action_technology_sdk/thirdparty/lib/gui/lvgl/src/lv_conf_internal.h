...
/* Use Custom GPU init. */
#ifndef LV_USE_DRAW_CUSTOM_GPU_INIT
    #ifdef CONFIG_LV_USE_DRAW_CUSTOM_GPU_INIT
        #define LV_USE_DRAW_CUSTOM_GPU_INIT CONFIG_LV_USE_DRAW_CUSTOM_GPU_INIT
    #else
...
#endif
#if LV_USE_STRACE
    #ifndef LV_USE_STRACE_OBJ_DRAW
        #ifdef CONFIG_LV_USE_STRACE_OBJ_DRAW
            #define LV_USE_STRACE_OBJ_DRAW CONFIG_LV_USE_STRACE_OBJ_DRAW
        #else
            #define LV_USE_STRACE_OBJ_DRAW 0
        #endif
    #endif
    #ifndef LV_USE_STRACE_TASK_DRAW
        #ifdef CONFIG_LV_USE_STRACE_TASK_DRAW
            #define LV_USE_STRACE_TASK_DRAW CONFIG_LV_USE_STRACE_TASK_DRAW
        #else
            #define LV_USE_STRACE_TASK_DRAW 0
        #endif
    #endif
#else
    #define LV_USE_STRACE_OBJ_DRAW 0
