...
uint32_t lv_anim_speed_to_time(uint32_t speed, int32_t start, int32_t end)
{
    ...
    uint32_t time = (d * 1000) / (speed ? speed : 1);
...
#ifdef LV_STRACE_ID_ANIM_CB
            LV_STRACE_U32X4(LV_STRACE_ID_ANIM_CB, (uintptr_t)a, (uintptr_t)a->var, (uintptr_t)a->exec_cb, a->act_time);
#endif
...
#ifdef LV_STRACE_ID_ANIM_CB
            LV_STRACE_CALL_U32(LV_STRACE_ID_ANIM_CB, (uintptr_t)a);
#endif
        }
