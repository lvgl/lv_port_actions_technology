...
struct audio_v2_format_i_type_descriptor
{
    uint8_t bLength;
    uint8_t bDescriptorType;
    uint8_t bDescriptorSubtype;
    uint8_t bFormartType;
    uint8_t bFormatType;
    uint8_t bSubslotSize;
    uint8_t bBitResolution;
}__PACKED;

#define AUDIO_V2_SIZEOF_FORMAT_I_TYPE_DESC (6)

struct audio_v2_as_alt_setting
{
    uint8_t alt_setting_desc[9];
    struct audio_v2_cs_if_as_general_descriptor cs_if_as_general_desc;
    struct audio_v2_format_i_type_descriptor format_i_type_desc;
    struct audio_ep_descriptor ep_desc;
} __PACKED;
struct audio_v2_as_feedback_alt_setting
{
    uint8_t alt_setting_desc[9];
    struct audio_v2_cs_if_as_general_descriptor cs_if_as_general_desc;
    struct audio_v2_format_i_type_descriptor format_i_type_desc;
    struct audio_ep_descriptor ep_desc;
    uint8_t fb_ep_desc[7];
} __PACKED;
...
#define AUDIO_V2_STD_AC_DESCRIPTOR_INIT(bInterface, bAlternateSetting, bNumEndpoints ,wTotalLength, bCategory, bmControls, stridx)\
    /* ------------------ AudioControl Interface ------------------ */\
    0x09,                            /* bLength */                                                                               \
    USB_DESCRIPTOR_TYPE_INTERFACE,   /* bDescriptorType */                                                                       \
...
#define AUDIO_V2_STD_AC_DESCRIPTOR_INIT_LEN (0x09)

#define AUDIO_V2_AC_INTERRUPT_DESCRIPTOR_INIT(bFirstInterface, bInterfaceCount, wTotalLength, bCategory, bmControls, stridx)     \
    /* Interface Association Descriptor */                                                                                       \
    0x08,                                                                                                                        \
    USB_DESCRIPTOR_TYPE_INTERFACE_ASSOCIATION,                                                                                   \
    bFirstInterface,                                                                                                             \
    ...
    0x00,                                                                                                                        \
    /* ------------------ AudioControl Interface ------------------ */\
    AUDIO_V2_STD_AC_DESCRIPTOR_INIT(bFirstInterface, 0x00, 0x01 , wTotalLength, bCategory, bmControls, stridx)

#define AUDIO_V2_AC_INTERRUPT_EP_INIT(bEndpointAddress, bInterval)                                                               \
    0x07,                           /* bLength: Endpoint Descriptor size */                                                      \
    USB_DESCRIPTOR_TYPE_ENDPOINT,   /* bDescriptorType: */                                                                       \
    bEndpointAddress,               /* bEndpointAddress: Endpoint Address (IN) */                                                \
    0x03,                           /* bmAttributes: Interrupt endpoint */                                                       \
    WBVAL(0x06),                    /* wMaxPacketSize: 6 Bytes for UAC 2.0 */                                                    \
...
#define AUDIO_V2_AS_FLOAT_DESCRIPTOR_INIT(bInterfaceNumber, bTerminalLink, bNrChannels, bmChannelConfig, bSubslotSize, bBitResolution, bEndpointAddress, bmAttributes, wMaxPacketSize, bInterval) \
    0x09,                            /* bLength */                                                                                                                        \
    USB_DESCRIPTOR_TYPE_INTERFACE,   /* bDescriptorType */                                                                                                                \
    bInterfaceNumber,                /* bInterfaceNumber */                                                                                                               \
    0x00,                            /* bAlternateSetting */                                                                                                              \
    ...
    0x05,                            /* bmControls */                                                                                                                     \
    AUDIO_FORMAT_TYPE_I,             /* bFormatType : AUDIO_FORMAT_TYPE_I */                                                                                              \
    DBVAL(AUDIO_V2_FORMAT_IEEE_FLOAT),      /* bmFormats PCM */                                                                                                                  \
    bNrChannels,                     /* bNrChannels */                                                                                                                    \
    DBVAL(bmChannelConfig),          /* bmChannelConfig */                                                                                                                \
    0x00,                            /* iChannelNames */                                                                                                                  \
    0x06,                            /* bLength */                                                                                                                        \
...
#define AUDIO_V2_AS_DESCRIPTOR_ALT_SETTING(bInterfaceNumber, bAlternateSetting, bTerminalLink, bNrChannels, bmChannelConfig, bSubslotSize, bBitResolution, bEndpointAddress, bmAttributes, wMaxPacketSize, bInterval) \
    0x09,                            /* bLength */                                                                                                                        \
    USB_DESCRIPTOR_TYPE_INTERFACE,   /* bDescriptorType */                                                                                                                \
    bInterfaceNumber,                /* bInterfaceNumber */                                                                                                               \
    bAlternateSetting,               /* bAlternateSetting */                                                                                                              \
...
#define AUDIO_V2_AS_FEEDBACK_DESCRIPTOR_ALT_SETTING(bInterfaceNumber, bAlternateSetting, bTerminalLink, bNrChannels, bmChannelConfig, bSubslotSize, bBitResolution, bEndpointAddress, wMaxPacketSize, bInterval, bFeedbackEndpointAddress) \
    0x09,                            /* bLength */                                                                                                                        \
    USB_DESCRIPTOR_TYPE_INTERFACE,   /* bDescriptorType */                                                                                                                \
    bInterfaceNumber,                /* bInterfaceNumber */                                                                                                               \
    bAlternateSetting,               /* bAlternateSetting */                                                                                                              \
