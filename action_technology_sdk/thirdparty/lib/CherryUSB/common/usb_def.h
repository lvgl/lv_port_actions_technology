...
/**< maximum packet size (MPS) for interrupt EP */
#define USB_INTR_EP_MPS_HS	1024
#define USB_INTR_EP_MPS_FS	64

/**< maximum packet size (MPS) for iso EP */
#define USB_ISO_EP_MPS_HS	1024
#define USB_ISO_EP_MPS_FS	1023
